...
class OceanDataDashboard:
    ...
    def _create_mock_species_data(self):
        ...
        for i in range(n_records):
            data.append({
                ...
                'decimalLatitude': np.random.uniform(10.0, 18.0),  # Deep ocean coordinates (Arabian Sea)
                'decimalLongitude': np.random.uniform(65.0, 75.0),  # Deep ocean coordinates (Arabian Sea)
    ...
    def _create_mock_vessels_data(self):
        ...
        for i in range(n_records):
            data.append({
                ...
                'latitude': np.random.uniform(10.0, 18.0),  # Deep ocean coordinates (Arabian Sea)
                'longitude': np.random.uniform(65.0, 75.0),  # Deep ocean coordinates (Arabian Sea)
    ...
    def _create_mock_edna_data(self):
        ...
        for i in range(n_records):
            data.append({
                ...
                'location_lat': np.random.uniform(10.0, 18.0),  # Deep ocean coordinates (Arabian Sea)
                'location_lon': np.random.uniform(65.0, 75.0),  # Deep ocean coordinates (Arabian Sea)
    ...
    def render_map_tab(self):
        ...
        # Create map
        # Set map center to deep Arabian Sea (ocean area)
        center_lat = 14.0  # Deep Arabian Sea coordinates
        center_lon = 70.0   # Deep Arabian Sea coordinates
